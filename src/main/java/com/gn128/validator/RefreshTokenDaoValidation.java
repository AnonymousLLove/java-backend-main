...
public class RefreshTokenDaoValidation {
    ...
    public Object validate(String refreshToken, HttpServletRequest httpServletRequest) {
        Optional<RefreshToken> byRefreshTokenOptional = refreshTokenDao.findByRefreshToken(refreshToken);
        ...
        RefreshToken refreshTokenEntity = byRefreshTokenOptional.get();
