...
public class NativeRefreshTokenValidator {
    ...
    public void validate(String refreshToken) {
        try {
            ...
            if (isExpired) throw new AuthenticationException(ExceptionMessages.EXPIRED_JWT_TOKEN);
            else throw new AuthenticationException(ExceptionMessages.BAD_JWT_TOKEN);
        } catch (BadJwtException exception) {
            throw new AuthenticationException(ExceptionMessages.BAD_JWT_TOKEN);
        }
    }
}
